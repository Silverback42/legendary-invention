...
import '../../features/transactions/presentation/monthly_totals_screen.dart';
...
abstract class AppRoutes {
  ...
  static const addMonthlyTotals = '/transactions/monthly-add';
...
final appRouterProvider = Provider<GoRouter>((ref) {
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: AppRoutes.addMonthlyTotals,
        builder: (context, state) => const MonthlyTotalsScreen(),
      ),
      GoRoute(
