...
- [x] Alternativer Eingabe-Modus: Gesamtsumme pro Kategorie für einen Monat
...
- [x] Swipe-to-Delete
- [x] Transaktion bearbeiten (Tap öffnet Edit-Screen)
- [x] Filtern nach Monat (Vor/Zurück-Navigation)
...
- [x] FAB (Floating Action Button) für schnelle Eingabe

### Einstellungen (Basis)
- [x] Währung wählen (EUR Standard, CHF als Option)
- [x] Sprache wählen (DE/EN)
- [x] Eingabe-Modus wählen (Einzeltransaktion / Monatssummen)
- [x] Daten löschen (mit Bestätigung)
